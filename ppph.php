...
<body>
	...
	<div class="container">
		...
		<div>
			...
			echo "<br>";
			echo "1.Create a variable called array that contains an array with three simple values.These values can be whatever you like.Explicitly index of ‘third’ to the third element.
			...
			<br><br>";
			$array = ['number' => 1, 'string'=>'Hello', 'third'=>false];
            foreach($array as $index => $value) {
            echo $index . '=' . $value . '<br>' ;
			}
			echo "<br><br>";

//date("G") give you current time.			
$hour = date("G");              
if ($hour < 12) {
echo "Good morning!";
}
